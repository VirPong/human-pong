package com.android.BluetoothPlugin;
...
public class BTDeviceManager extends Plugin{
	...
	private GetDiscoverableDevices add;
	...
	public PluginResult execute(String action, JSONArray args, String callbackId){
		if(action.equals("getDevices")){
			add=new GetDiscoverableDevices();
			add.mHandler = this.mHandler;
			add.execute(BTDeviceManager.this);
			
			return new PluginResult(PluginResult.Status.OK, "HELLO!");
		}
		else{
