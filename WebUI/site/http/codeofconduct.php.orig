...
<p><h3>I. You may do the following:</h3>
	<ul>
		<li>Be polite and treat others with respect. Just because you're online doesn't mean you should be a jerk.</li>
		<li>Welcome newcomers. The more people on the Services, the more fun for everyone.</li>
		<li>Know your privacy settings and use them to help create and control the experience you want. If you're a parent, you can use Family Settings to control the activities and experiences available to your kid. For example, you can prohibit voice and video communication, block purchasing, and choose who your kid is allowed to play with online.</li>
		<li>Make friends.</li>
		<li>Have fun!</li>
	</ul>
</p>
...
<p><h3>II. Do not do the following:</h3>
	<ul>
		...
		<li>Do not create a gamertag, profile content, or in-game content that references controversial religious topics, notorious people, organizations, or sensitive current or historical events that may be considered inappropriate.</li>
		<li>Do not distribute, post, publish, upload, disseminate or discuss defamatory, infringing, obscene, sexual or unlawful materials in any format (images, audio, video, text, etc.). Prohibited materials include, without limitation, child pornography or illegal drugs. "Sound alike" words or phrases or puns that reference these topics are also prohibited.</li>
		<li>Do not post links to websites that violate the Code of Conduct.</li>
		<li>Donot give out personal information of other players (such as their real name, address, phone number, credit card number, etc.) in any way (including, without limitation, through voice chat or the names you create for your gamertag or mottos). This information could be used by other players for illegal or harmful purposes. You should also avoid giving out your own personal information.</li>
