...
%%%%%%%%%%%%%%%
	...
	\subsection{Use Cases}
		...
		\begin{description}
			...
			\item[7.] Repeat 4, 5, 6, and 7 until information stream ends from Game Manager
			\item[8.] System closes connection to the Game Manager
			\item[9.] System informs User that the game is over
		\end{description}
