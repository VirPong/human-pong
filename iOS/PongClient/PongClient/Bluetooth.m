...
bd_addr_t addr = {0x00, 0x23, 0xCC, 0x85, 0xFA, 0x0A };  // WiiMote
...
// THIS IS WHERE THE TEST.C THINGY BEGINS!!!    
...
// THIS IS WHERE THE TEST.C THINGY ENDS!!!
//	bd_addr_t event_addr;
//
